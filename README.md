...
|III|Nov. 1|Concept Review|***A. Final Scope:*** Delving Deeper<br><br>***A.1.*** Choose a single direction → Most Inspiring, Most Memorable<br><br>***A.2.*** Set Up Parameters → Exhaustive list of what needs to be done/developed in order to meet the deliverables|
...
|IV|Nov. 8|Prototyping|***A. Final Edit:*** Edit and Arrange <br><br>***A.1.*** Planning → Make a thorough plan of what needs to be done when <br><br>***A.2.*** Sourcing → Map out the resources needed (e.g. Rendering/Printing time, Technician help/advice, workshops, materials, …)|
...
|V|Nov. 15|Communication|***A. Sequencing***<br><br>***A.1.*** Presenting → Narrate your narrative, Start with the big idea, delve into exciting the details|
